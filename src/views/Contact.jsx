...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className={darkMode ? "bg-gray-100 pt-24 pb-24 md:h-screen" : "bg-black pt-24 text-white md:h-screen"}
    >
          ...
          <div className="w-full md:pr-8">
            <form onSubmit={handleSubmit}>
              <div className="my-6">
                <label
                  htmlFor="name"
                  className={darkMode ? "block mb-2 text-lg font-medium text-gray-900" : "block mb-2 text-lg font-medium text-white "}
                >
                  Name
                </label>
                <input
              ...
              {status && (
                <div className={`mb-4 text-center ${status.includes("Error") || status.includes("Failed") ? "text-red-500" : "text-green-500"}`}>
                  {status}
                </div>
              )}
